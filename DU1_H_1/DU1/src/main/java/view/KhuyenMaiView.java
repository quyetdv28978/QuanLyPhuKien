...
//            return;
    ...
    public void finTrangThai1(List<KhuyenMai> list) {

        dtm = (DefaultTableModel) tbHienThiSP.getModel();
        dtm.setRowCount(0);

        List<KhuyenMai> khvm = khuyenMaiResponsitories.SelectbyTrangThai((String) cbbCTKM.getSelectedItem());
        for (KhuyenMai khvms : khvm) {
            if (khvms.getTT().equalsIgnoreCase("Hết Hạn")) {
                khvms.setTrangThai("Hết Hạn");
                khuyenMaiResponsitories.update(khvms);
//            return;
    ...
    private KhuyenMai getData(String dk) {
      ...
      if (new Date().getTime() < dateNgayBD.getDate().getTime()) {
            tt = "Chưa Hoạt Động ";
        } else {
            tt = "Còn Hạn";
        }
        if (dk.equalsIgnoreCase("update")) {
            ...
            return new domaimodel.KhuyenMai(tbHienThi.getValueAt(tbHienThi.getSelectedRow(), 0).toString(),
                    ...
                    dateNgayBD.getDate(), dateNgayKT.getDate(), tt, txtAMoTaKM.getText().trim());
        }

        return new KhuyenMai(jcheck.createID().toString(),
                jcheck.randomMA(),
                txtTenKhuyenMai.getText().trim(), Float.parseFloat(txtGiaGiam.getText().trim()),
                dateNgayBD.getDate(), dateNgayKT.getDate(), tt,
...
//            //ngày bđ lớn hơn 30 ngày
    ...
    private void initComponents() {
        ...
        cbbCTKM = new javax.swing.JComboBox<>();
        ...
        tbHienThi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã KM", "Tên Chương Trình", "Ngày Bắt Đầu", "Ngày Kết Thúc", "Giá Giảm", "Trạng Thái", "Mô Tả"
            }
        ));
        ...
        cbbCTKM.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Còn Hạn", "Hết Hạn", "Chưa Hoạt Động" }));
        cbbCTKM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbbCTKMActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(76, 76, 76)
                        .addComponent(cbbCTKM, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(31, 31, 31)
                        .addComponent(cbbCTKM, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
//        System.out.println("aaaaaaaa" + dateNgayBD.getDate());
    ...
    private void cbbCTKMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbCTKMActionPerformed
        String a = (String) cbbCTKM.getSelectedItem();
//        System.out.println("1 :" + a);
        List<KhuyenMai> list = khuyenMaiResponsitories.SelectbyTrangThai(a);
        finTrangThai1(list);
    }//GEN-LAST:event_cbbCTKMActionPerformed
    ...
    private javax.swing.JComboBox<String> cbbCTKM;
