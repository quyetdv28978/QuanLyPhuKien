    ...
    private ChatLieuViewModel getData(String dk) {
        ...
        if (dk.equalsIgnoreCase("update")) {
            ...
            return new ChatLieuViewModel(tbHienThi.getValueAt(tbHienThi.getSelectedRow(), 0).toString(),
                    tbHienThi.getValueAt(tbHienThi.getSelectedRow(), 1).toString(), txtTenChatLieu.getText().trim());
        }
        return new ChatLieuViewModel(jcheck.createID().toString(), jcheck.randomMA(), txtTenChatLieu.getText().trim());
    }
