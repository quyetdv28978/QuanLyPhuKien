 ...
 * @author ADMIN
 */
public class viewSanPham_1 extends javax.swing.JFrame {
...
//        System.out.println(((DanhMucViewModel)dcmDongSP_SP.getSelectedItem()).getId());        // TODO add your handling code here:
    ...
    private void btnsanphamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsanphamActionPerformed
        this.dispose();
        new viewSanPham_1().setVisible(true);        // TODO add your handling code here:
...
//        searchByTT(sp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewSanPham_1.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewSanPham_1().setVisible(true);
            }
        });
    }
