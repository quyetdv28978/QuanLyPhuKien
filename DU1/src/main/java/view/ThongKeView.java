...
//        DefaultTableModel dtmThongke = (DefaultTableModel) tblxuat.getModel();
//        dtmThongke.setRowCount(0);
//        dtmThongke.addRow(new Object[]{12, 10000000});
//        dtmThongke.addRow(new Object[]{15, 20000000});
//        dtmThongke.addRow(new Object[]{20, 30000000});
        loadDTHT();
        
        new Bieudo1().setDataToChart1(jPanel17);
    }
