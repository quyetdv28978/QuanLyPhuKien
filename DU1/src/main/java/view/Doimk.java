...
public class Doimk extends javax.swing.JFrame {
  private resquenmk qmk;
    ...
    private void btmdmkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmdmkActionPerformed
       ...
       if(txtmkm.getText().trim().equalsIgnoreCase(txtnhaplai.getText().trim())&&txttk.getText().trim().equalsIgnoreCase(qmk.gettk().get(i).getTenTaiKhoan())){
