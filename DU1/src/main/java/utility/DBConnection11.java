 ...
 * @author dungna29
 */
public class DBConnection11 {//Lớp này giải quyết kết nối xử lý truy vấn

    private static String hostName = "localhost";
    private static String acc = "sa";
    private static String pass = "1";
    private static String dbName = "DU1_NHOM1";
    ...
    //2. Thực thi truy vấn Thêm, Sửa , Xoá
       ...
       public static int ExcuteDungna(String sql, Object... args) {
        ...
        try {
            try {
                pstm = DBConnection11.openDbConnection().prepareStatement(sql);
