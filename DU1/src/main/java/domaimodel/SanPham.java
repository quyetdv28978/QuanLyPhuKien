...
//test excel
    ...
    public SanPham(String id, String ma, String tenSanPham, Float giaBan, Float trongLuong,
            Integer soLuong, Float kichThuoc, String chatLieu, DanhMuc dm, Integer trangThai) {
        this.id = id;
        this.ma = ma;
        this.tenSanPham = tenSanPham;
        this.giaBan = giaBan;
    ...
    public static void main(String[] args) {
        DBConnection.executeQuery(new SanPham(new JframeCheck().createID().toString(), new DanhMuc(new JframeCheck().createID().toString())), null);
    }
}
